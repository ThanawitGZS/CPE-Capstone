...
func SetupDatabase() {
	...
	OwnerRole := entity.Role{RoleName: "เจ้าของร้าน", RoleNickName: "OW"}
	ManagerRole := entity.Role{RoleName: "ผู้จัดการ", RoleNickName: "MN"}
	EmployeeRole := entity.Role{RoleName: "พนักงาน", RoleNickName: "EMP"}

	OwnerRoleNumber := entity.Number{Numb: 1, RoleID: 1}
	...
	db.FirstOrCreate(&EmployeeRole, entity.Role{RoleName: "พนักงาน", RoleNickName: "EMP"})

	db.Where("role_id = ?", OwnerRole.ID).FirstOrCreate(&OwnerRoleNumber, entity.Number{Numb: 1, RoleID: OwnerRole.ID})
